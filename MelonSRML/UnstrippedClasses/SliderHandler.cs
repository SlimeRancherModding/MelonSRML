...
namespace MelonSRML.UnstrippedClasses
{
    ...
    internal class SliderStateModified : Il2CppSystem.Object
    {
        public SliderStateModified(IntPtr value) : base(value)
        {}
    ...
    internal struct SliderHandler
    {
        ...
        private float OnMouseDown()
        {
            ...
            if (SupportsPageMovements())
            {
                ...
                var addMilliseconds = Il2CppSystem.DateTime.Now.AddMilliseconds(250);
                Patch_GUI.SetNextScrollStepTime(addMilliseconds);
                //GUI.nextScrollStepTime = Il2CppSystem.DateTime.Now.AddMilliseconds(TestingMod.UnstrippedClasses.ScrollWaitDefinitions.firstWait);
        ...
        private float OnRepaint()
        {
            ...
            if (DateTime.Now < Patch_GUI.GetNextScrollStepTime())
                return currentValue;

            if (CurrentScrollTroughSide() != GUI.scrollTroughSide)
                return currentValue;

            var addMilliseconds = Il2CppSystem.DateTime.Now.AddMilliseconds(30);
            Patch_GUI.SetNextScrollStepTime(addMilliseconds);
            //GUI.nextScrollStepTime = Il2CppSystem.DateTime.Now.AddMilliseconds(TestingMod.UnstrippedClasses.ScrollWaitDefinitions.regularWait);
        ...
        private SliderStateModified SliderState()
        {
            return GUIUtility.GetStateObject(Il2CppType.Of<SliderStateModified>(), id).Cast<SliderStateModified>();
        }
